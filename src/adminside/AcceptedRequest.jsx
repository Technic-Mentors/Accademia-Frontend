...
export default function AcceptedRequest() {
    ...
    const checkRequest = request.filter(course => course.status === "Y")
            ...
            <div className="mt-3">
                <div className="table-container" style={{ overflowX: "auto" }}>
                    <table className="table table-responsive">
                        ...
                        <tbody>
                            {request.filter(request => request.status === "Y").map((request, index) => (
                                <tr key={index}>
                    ...
                    <div className="row d-flex justify-content-center align-items-center">
                        ...
                        <div className="col-md-8">
                            <div className="section-header">
                                <h2>You Are Yet To Accept A Course Enrollment Request </h2>
                            </div>
                            <p>You will be able to see the accepted requests when you approve course enrollment request.</p>
                        </div>
                    </div>
                </div>
            </div>
